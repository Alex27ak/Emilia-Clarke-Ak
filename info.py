...
API_ID = int(environ.get('API_ID', '11450835'))
API_HASH = environ.get('API_HASH', '0fadb61feae6ccf016932823bbf1565c')
BOT_TOKEN = environ.get('BOT_TOKEN', "5514956449:AAF3EsHfrk5DBkM5E1tXp7MRAiFdmy2Wdpg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1254785184').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001527524694 -1001558581694 -1002095624551 -1002129413187').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001627812746')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Alex1206:Alex1206@cluster0.nixkcmr.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '17950084501a0650a1be53be2dc8437fa202f0ce')
...
STREAM_LOG = int(environ.get('STREAM_LOG', '-1002025354142'))
