...
URL = "https://aklinkszstreaming.site/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://aklinkszstreaming.site/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://aklinkszstreaming.site/".format(FQDN)
else:
    URL = "https://aklinkszstreaming.site/".format(FQDN)
