...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/aklinksz_admin")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support',url="https://t.me/Aklinksz_support_bot"),
            InlineKeyboardButton('Owner', url="https://t.me/aklinksz_admin")
        ],[
